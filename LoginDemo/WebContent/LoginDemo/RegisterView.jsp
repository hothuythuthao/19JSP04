						...
						<tr>
							...
							<td>
								<select name="poc">
									...
									<option value="danang">Ha Noi</option>
									<option value="danang">Hue</option>
									<option value="danang">Thanh Hoa</option>
									<option value="danang">Quang Binh</option>
									<option value="danang">Nghe An</option>
									<option value="danang">Ha Tinh</option>
									<option value="danang">Phu Yen</option>
									<option value="danang">Ninh Binh</option>
								</select>
							</td>
						</tr>
						<tr>
