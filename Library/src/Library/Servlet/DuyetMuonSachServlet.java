...
@WebServlet("/DuyetMuonSachServlet")
public class DuyetMuonSachServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public DuyetMuonSachServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (user == null) {
			...
			try {
				...
				ubService.duyetMuonSach(userBook, user.getUserID());
